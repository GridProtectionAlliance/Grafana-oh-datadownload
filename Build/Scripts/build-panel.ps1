...
#     .\build-panel.ps1 "C:\Projects\openHistorianAlarmPanel"
...
#$projectDir = "D:\Projects\GrafanaPanels\openHistorianGrafanaAlarmPanel"
...
Set-Variable repo       	   -Option Constant -Scope Script -Value "Grafana-oh-datadownload"
Set-Variable pluginFile        -Option Constant -Scope Script -Value "Source/src/plugin.json"
